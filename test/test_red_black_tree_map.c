...
static void check_invalidate_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_invalidate(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_invalidate(void **state) {
    struct coral_red_black_tree_map object = {};
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}

static void check_init_error_on_object_is_null(void **state) {
    assert_int_equal(coral_red_black_tree_map_init(NULL,
                                                   sizeof(uintmax_t),
                                                   sizeof(uintmax_t),
                                                   (void *) 1),
                     CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
...
static void check_init_error_on_key_size_is_zero(void **state) {
    assert_int_equal(coral_red_black_tree_map_init((void *) 1,
                                                   0,
                                                   sizeof(uintmax_t),
                                                   (void *) 1),
                     CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_SIZE_IS_ZERO);
}
...
static void check_init_error_on_value_size_is_zero(void **state) {
    assert_int_equal(coral_red_black_tree_map_init((void *) 1,
                                                   ...
                                                   0,
                                                   (void *) 1),
                     CORAL_RED_BLACK_TREE_MAP_ERROR_VALUE_SIZE_IS_ZERO);
}
...
static void check_init_error_on_compare_is_null(void **state) {
    assert_int_equal(coral_red_black_tree_map_init((void *) 1,
                                                   ...
                                                   sizeof(uintmax_t),
                                                   NULL),
                     CORAL_RED_BLACK_TREE_MAP_ERROR_COMPARE_IS_NULL);
}
...
static void check_init_error_on_entry_size_is_too_large(void **state) {
    assert_int_equal(coral_red_black_tree_map_init((void *) 1,
                                                   ...
                                                   sizeof(uintmax_t),
                                                   (void *) 1),
                     CORAL_RED_BLACK_TREE_MAP_ERROR_ENTRY_SIZE_IS_TOO_LARGE);
    assert_int_equal(coral_red_black_tree_map_init((void *) 1,
                                                   sizeof(uintmax_t),
                                                   SIZE_MAX,
                                                   (void *) 1),
...
static void check_init(void **state) {
    struct coral_red_black_tree_map object;
    assert_int_equal(coral_red_black_tree_map_init(
            &object,
            sizeof(uintmax_t),
            sizeof(uintmax_t),
            uintmax_t_ptr_compare), 0);
...
static void check_key_size_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_key_size(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_key_size_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_key_size((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_key_size(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_init(
            ...
            uintmax_t_ptr_compare), 0);
    uintmax_t out;
    assert_int_equal(coral_red_black_tree_map_key_size(&object, &out), 0);
...
static void check_value_size_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_value_size(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_value_size_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_value_size((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_value_size(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_init(
            ...
            uintmax_t_ptr_compare), 0);
    uintmax_t out;
    assert_int_equal(coral_red_black_tree_map_value_size(&object, &out), 0);
...
static void check_count_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_count(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_count_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_count((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_count(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_init(
            ...
            uintmax_t_ptr_compare), 0);
    uintmax_t out;
    assert_int_equal(coral_red_black_tree_map_count(&object, &out), 0);
...
static void check_add_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_add(NULL, (void *) 1, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_add_error_on_key_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_add((void *) 1, NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_IS_NULL);
}

static void check_add_error_on_value_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_add((void *) 1, (void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_VALUE_IS_NULL);
}
...
static void check_add_error_on_memory_allocation_failed(void **state) {
    ...
    assert_int_equal(
            coral_red_black_tree_map_add(&object, &key, &value),
...
static void check_add(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
...
static void check_add_error_on_key_already_exists(void **state) {
    ...
    assert_int_equal(
            coral_red_black_tree_map_add(&object, &key, &value),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_ALREADY_EXISTS);
    assert_int_equal(1, object.tree.count);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_remove_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_remove(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_remove_error_on_key_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_remove((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_IS_NULL);
}
...
static void check_remove_error_on_key_not_found(void **state) {
    ...
    const uintmax_t key = (rand() % UINTMAX_MAX);
    assert_int_equal(
            coral_red_black_tree_map_remove(&object, &key),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_remove(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(1, object.tree.count);
    assert_int_equal(coral_red_black_tree_map_remove(&object, &key), 0);
    assert_int_equal(0, object.tree.count);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_contains(void **state) {
    ...
    bool result;
    key += 1;
    assert_int_equal(coral_red_black_tree_map_contains(
            &object, &key, &result), 0);
    assert_false(result);
    key -= 1;
    assert_int_equal(coral_red_black_tree_map_contains(
...
static void check_contains_error_on_memory_allocation_failed(void **state) {
    ...
    malloc_is_overridden = calloc_is_overridden = realloc_is_overridden
            = posix_memalign_is_overridden = true;
    assert_int_equal(
            coral_red_black_tree_map_contains(&object, &key, &result),
            CORAL_RED_BLACK_TREE_MAP_ERROR_MEMORY_ALLOCATION_FAILED);
    malloc_is_overridden = calloc_is_overridden = realloc_is_overridden
            = posix_memalign_is_overridden = false;
    assert_int_equal(coral_red_black_tree_map_invalidate(
...
static void check_get_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_get(NULL, (void *) 1, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_get_error_on_key_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_get((void *) 1, NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_IS_NULL);
}

static void check_get_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_get((void *) 1, (void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_get(void **state) {
    ...
    assert_int_equal(1, object.tree.count);
    const uintmax_t *out;
    assert_int_equal(coral_red_black_tree_map_get(
            &object, &key, (const void **) &out), 0);
    assert_int_equal(*out, value);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_ceiling_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_ceiling(NULL, (void *) 1, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_ceiling_error_on_key_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_ceiling((void *) 1, NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_IS_NULL);
}

static void check_ceiling_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_ceiling((void *) 1, (void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_ceiling_error_on_key_not_found(void **state) {
    ...
    const uintmax_t *out;
    assert_int_equal(
            coral_red_black_tree_map_ceiling(
                    &object, &key, (const void **) &out),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    key++;
...
static void check_ceiling(void **state) {
    ...
    const uintmax_t *out;
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(coral_red_black_tree_map_ceiling(
            &object, &key, (const void **) &out), 0);
...
static void check_floor_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_floor(NULL, (void *) 1, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_floor_error_on_key_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_floor((void *) 1, NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_IS_NULL);
}

static void check_floor_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_floor((void *) 1, (void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_floor_error_on_key_not_found(void **state) {
    ...
    const uintmax_t *out;
    assert_int_equal(
            coral_red_black_tree_map_floor(
                    &object, &key, (const void **) &out),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    key--;
...
static void check_floor(void **state) {
    ...
    const uintmax_t *out;
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(coral_red_black_tree_map_floor(
            &object, &key, (const void **) &out), 0);
    assert_ptr_not_equal(&value, out);
    assert_int_equal(value, *out);
    key = 21;
...
static void check_higher_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_higher(NULL, (void *) 1, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_higher_error_on_key_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_higher((void *) 1, NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_IS_NULL);
}

static void check_higher_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_higher((void *) 1, (void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_higher_error_on_key_not_found(void **state) {
    ...
    const uintmax_t *out;
    assert_int_equal(
            coral_red_black_tree_map_higher(
                    &object, &key, (const void **) &out),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(
...
static void check_higher(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    key = 99;
    assert_int_equal(coral_red_black_tree_map_higher(
            &object, &key, (const void **) &out), 0);
    assert_ptr_not_equal(&value, out);
    assert_int_equal(value, *out);
    key = 227;
...
static void check_lower_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_lower(NULL, (void *) 1, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_lower_error_on_key_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_lower((void *) 1, NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_IS_NULL);
}

static void check_lower_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_lower((void *) 1, (void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_lower_error_on_key_not_found(void **state) {
    ...
    const uintmax_t *out;
    assert_int_equal(
            coral_red_black_tree_map_lower(
                    &object, &key, (const void **) &out),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(
...
static void check_lower(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    key = 345;
    assert_int_equal(coral_red_black_tree_map_lower(
            &object, &key, (const void **) &out), 0);
    assert_ptr_not_equal(&value, out);
    assert_int_equal(value, *out);
    key = 21;
...
static void check_set_error_on_key_not_found(void **state) {
    ...
    const uintmax_t value = (rand() % UINTMAX_MAX);
    assert_int_equal(
            coral_red_black_tree_map_set(&object, &key, &value),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_set(void **state) {
    ...
    assert_int_equal(*out, value);
    value += (rand() % UINTMAX_MAX);
    assert_int_equal(coral_red_black_tree_map_set(&object, &key, &value), 0);
    assert_ptr_not_equal(out, &value);
    assert_int_equal(*out, value);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
...
static void check_first_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_first(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_first_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_first((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_first_error_on_map_is_empty(void **state) {
    ...
    const uintmax_t *out;
    assert_int_equal(
            coral_red_black_tree_map_first(&object, (const void **) &out),
            CORAL_RED_BLACK_TREE_MAP_ERROR_MAP_IS_EMPTY);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_first(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    const uintmax_t *out;
    assert_int_equal(coral_red_black_tree_map_first(
            &object, (const void **) &out), 0);
    assert_ptr_not_equal(out, &value);
    assert_int_equal(*out, value);
    key = 43;
    value += (rand() % UINTMAX_MAX);
...
static void check_last_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_last(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_last_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_last((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_last_error_on_map_is_empty(void **state) {
    ...
    const uintmax_t *out;
    assert_int_equal(
            coral_red_black_tree_map_last(&object, (const void **) &out),
            CORAL_RED_BLACK_TREE_MAP_ERROR_MAP_IS_EMPTY);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_last(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    const uintmax_t *out;
    assert_int_equal(coral_red_black_tree_map_last(
            &object, (const void **) &out), 0);
    assert_ptr_not_equal(out, &value);
    assert_int_equal(*out, value);
    key = 243;
...
static void check_get_entry_error_on_key_not_found(void **state) {
    ...
    assert_int_equal(
            coral_red_black_tree_map_get_entry(&object, &key, &out),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_get_entry(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_get_entry(
            &object, &key, &entry), 0);
    const uintmax_t *out;
    assert_int_equal(coral_red_black_tree_map_entry_key(
            &object, entry, (const void **) &out), 0);
    assert_ptr_not_equal(&key, out);
    assert_int_equal(key, *out);
    assert_int_equal(coral_red_black_tree_map_entry_get_value(
            &object, entry, (const void **) &out), 0);
    assert_ptr_not_equal(&value, out);
    assert_int_equal(value, *out);
    assert_int_equal(coral_red_black_tree_map_invalidate(
...
static void check_get_entry_error_on_memory_allocation_failed(void **state) {
    ...
    malloc_is_overridden = calloc_is_overridden = realloc_is_overridden
            = posix_memalign_is_overridden = true;
    assert_int_equal(
            coral_red_black_tree_map_get_entry(&object, &key, &entry),
            CORAL_RED_BLACK_TREE_MAP_ERROR_MEMORY_ALLOCATION_FAILED);
    malloc_is_overridden = calloc_is_overridden = realloc_is_overridden
            = posix_memalign_is_overridden = false;
    assert_int_equal(coral_red_black_tree_map_invalidate(
...
static void check_ceiling_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_ceiling_entry(NULL, (void *) 1, (void *)1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_ceiling_entry_error_on_key_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_ceiling_entry((void *) 1, NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_IS_NULL);
}

static void check_ceiling_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_ceiling_entry((void *) 1, (void *) 1,NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_ceiling_entry_error_on_key_not_found(void **state) {
    ...
    const struct coral_red_black_tree_map_entry *entry;
    assert_int_equal(
            coral_red_black_tree_map_ceiling_entry(&object, &key, &entry),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    key++;
    assert_int_equal(
...
static void check_ceiling_entry(void **state) {
    ...
    const struct coral_red_black_tree_map_entry *entry;
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(coral_red_black_tree_map_ceiling_entry(
            &object, &key, &entry), 0);
    const uintmax_t *out;
    assert_int_equal(coral_red_black_tree_map_entry_key(
            &object, entry, (const void **) &out), 0);
...
static void check_floor_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_floor_entry(NULL, (void *) 1, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_floor_entry_error_on_key_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_floor_entry((void *) 1, NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_IS_NULL);
}

static void check_floor_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_floor_entry((void *) 1, (void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_floor_entry_error_on_key_not_found(void **state) {
    ...
    const struct coral_red_black_tree_map_entry *entry;
    assert_int_equal(
            coral_red_black_tree_map_floor_entry(&object, &key, &entry),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    key--;
    assert_int_equal(
...
static void check_floor_entry(void **state) {
    ...
    const struct coral_red_black_tree_map_entry *entry;
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(coral_red_black_tree_map_floor_entry(
            &object, &key, &entry), 0);
    const uintmax_t *out;
    assert_int_equal(coral_red_black_tree_map_entry_key(
            &object, entry, (const void **) &out), 0);
...
static void check_higher_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_higher_entry(NULL, (void *) 1, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_higher_entry_error_on_key_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_higher_entry((void *) 1, NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_IS_NULL);
}

static void check_higher_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_higher_entry((void *) 1, (void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_higher_entry_error_on_key_not_found(void **state) {
    ...
    const struct coral_red_black_tree_map_entry *entry;
    assert_int_equal(
            coral_red_black_tree_map_higher_entry(&object, &key, &entry),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(
            coral_red_black_tree_map_higher_entry(&object, &key, &entry),
...
static void check_higher_entry(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_higher_entry(
            &object, &find, &entry), 0);
    const uintmax_t *out;
    assert_int_equal(coral_red_black_tree_map_entry_key(
            &object, entry, (const void **) &out), 0);
...
check_higher_entry_error_on_memory_allocation_failed(void **state) {
    ...
    malloc_is_overridden = calloc_is_overridden = realloc_is_overridden
            = posix_memalign_is_overridden = true;
    assert_int_equal(
            coral_red_black_tree_map_higher_entry(&object, &find, &entry),
            CORAL_RED_BLACK_TREE_MAP_ERROR_MEMORY_ALLOCATION_FAILED);
    malloc_is_overridden = calloc_is_overridden = realloc_is_overridden
            = posix_memalign_is_overridden = false;
    assert_int_equal(coral_red_black_tree_map_invalidate(
...
static void check_lower_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_lower_entry(NULL, (void *) 1, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}
...
static void check_lower_entry_error_on_key_not_found(void **state) {
    ...
    const struct coral_red_black_tree_map_entry *entry;
    assert_int_equal(
            coral_red_black_tree_map_lower_entry(&object, &key, &entry),
            CORAL_RED_BLACK_TREE_MAP_ERROR_KEY_NOT_FOUND);
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(
            coral_red_black_tree_map_lower_entry(&object, &key, &entry),
...
static void check_lower_entry(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_lower_entry(
            &object, &find, &entry), 0);
    const uintmax_t *out;
    assert_int_equal(coral_red_black_tree_map_entry_key(
            &object, entry, (const void **) &out), 0);
...
static void check_lower_entry_error_on_memory_allocation_failed(void **state) {
    ...
    malloc_is_overridden = calloc_is_overridden = realloc_is_overridden
            = posix_memalign_is_overridden = true;
    assert_int_equal(
            coral_red_black_tree_map_lower_entry(&object, &find, &entry),
            CORAL_RED_BLACK_TREE_MAP_ERROR_MEMORY_ALLOCATION_FAILED);
    malloc_is_overridden = calloc_is_overridden = realloc_is_overridden
            = posix_memalign_is_overridden = false;
    assert_int_equal(coral_red_black_tree_map_invalidate(
...
static void check_first_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_first_entry(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_first_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_first_entry((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_first_entry_error_on_map_is_empty(void **state) {
    ...
    const struct coral_red_black_tree_map_entry *out;
    assert_int_equal(
            coral_red_black_tree_map_first_entry(&object, &out),
            CORAL_RED_BLACK_TREE_MAP_ERROR_MAP_IS_EMPTY);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_first_entry(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    const struct coral_red_black_tree_map_entry *entry;
    assert_int_equal(coral_red_black_tree_map_first_entry(&object, &entry), 0);
    const uintmax_t *check;
    assert_int_equal(coral_red_black_tree_map_entry_key(
            &object, entry, (const void **) &check), 0);
...
static void check_last_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_last_entry(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_last_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_last_entry((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_last_entry_error_on_map_is_empty(void **state) {
    ...
    const struct coral_red_black_tree_map_entry *out;
    assert_int_equal(
            coral_red_black_tree_map_last_entry(&object, &out),
            CORAL_RED_BLACK_TREE_MAP_ERROR_MAP_IS_EMPTY);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_last_entry(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    const struct coral_red_black_tree_map_entry *entry;
    assert_int_equal(coral_red_black_tree_map_last_entry(&object, &entry), 0);
    const uintmax_t *check;
    assert_int_equal(coral_red_black_tree_map_entry_key(
            &object, entry, (const void **) &check), 0);
    assert_ptr_not_equal(&key, check);
...
static void check_remove_entry_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_remove_entry(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}

static void check_remove_entry_error_on_entry_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_remove_entry((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_ENTRY_IS_NULL);
}
...
static void check_remove_entry(void **state) {
    ...
    for (uintmax_t i = 0; i < 3; i++) {
        uintmax_t value = (rand() % UINTMAX_MAX);
        assert_int_equal(coral_red_black_tree_map_add(
                &object, &i, &value), 0);
    }
    const struct coral_red_black_tree_map_entry *entry;
    uintmax_t key = 1;
    assert_int_equal(coral_red_black_tree_map_get_entry(
            &object, &key, &entry), 0);
    uintmax_t count;
    assert_int_equal(coral_red_black_tree_map_count(&object, &count), 0);
    assert_int_equal(count, 3);
    assert_int_equal(coral_red_black_tree_map_remove_entry(&object, entry), 0);
    assert_int_equal(coral_red_black_tree_map_count(&object, &count), 0);
...
static void check_next_entry_error_on_entry_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_next_entry(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_ENTRY_IS_NULL);
}

static void check_next_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_next_entry((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_next_entry_error_end_of_sequence(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_last_entry(&object, &entry), 0);
    assert_int_equal(
            coral_red_black_tree_map_next_entry(entry, &entry),
            CORAL_RED_BLACK_TREE_MAP_ERROR_END_OF_SEQUENCE);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_next_entry(void **state) {
    ...
    value += (rand() % UINTMAX_MAX);
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(coral_red_black_tree_map_next_entry(entry, &entry), 0);
    const uintmax_t *check;
    assert_int_equal(coral_red_black_tree_map_entry_key(
            &object, entry, (const void **) &check), 0);
    assert_ptr_not_equal(&key, check);
...
static void check_prev_entry_error_on_entry_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_prev_entry(NULL, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_ENTRY_IS_NULL);
}

static void check_prev_entry_error_on_out_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_prev_entry((void *) 1, NULL),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OUT_IS_NULL);
}
...
static void check_prev_entry_error_end_of_sequence(void **state) {
    ...
    assert_int_equal(coral_red_black_tree_map_first_entry(&object, &entry), 0);
    assert_int_equal(
            coral_red_black_tree_map_prev_entry(entry, &entry),
            CORAL_RED_BLACK_TREE_MAP_ERROR_END_OF_SEQUENCE);
    assert_int_equal(coral_red_black_tree_map_invalidate(
            &object, NULL), 0);
}
...
static void check_prev_entry(void **state) {
    ...
    value += (rand() % UINTMAX_MAX);
    assert_int_equal(coral_red_black_tree_map_add(&object, &key, &value), 0);
    assert_int_equal(coral_red_black_tree_map_prev_entry(entry, &entry), 0);
    const uintmax_t *check;
    assert_int_equal(coral_red_black_tree_map_entry_key(
            &object, entry, (const void **) &check), 0);
    assert_ptr_not_equal(&key, check);
...
static void check_entry_set_value_error_on_object_is_null(void **state) {
    assert_int_equal(
            coral_red_black_tree_map_entry_set_value(
                    NULL, (void *) 1, (void *) 1),
            CORAL_RED_BLACK_TREE_MAP_ERROR_OBJECT_IS_NULL);
}
...
static void check_entry_set_value(void **state) {
    ...
    assert_int_equal(value, *check);
    value += (rand() % UINTMAX_MAX);
    assert_int_equal(coral_red_black_tree_map_entry_set_value(

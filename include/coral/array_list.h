...
#define CORAL_ARRAY_LIST_ERROR_OBJECT_IS_NULL                       1
#define CORAL_ARRAY_LIST_ERROR_SIZE_IS_ZERO                         2
#define CORAL_ARRAY_LIST_ERROR_MEMORY_ALLOCATION_FAILED             3
#define CORAL_ARRAY_LIST_ERROR_OUT_IS_NULL                          4
#define CORAL_ARRAY_LIST_ERROR_INDEX_IS_OUT_OF_BOUNDS               5
#define CORAL_ARRAY_LIST_ERROR_LIST_IS_EMPTY                        6
#define CORAL_ARRAY_LIST_ERROR_COUNT_IS_ZERO                        7
#define CORAL_ARRAY_LIST_ERROR_ITEMS_IS_NULL                        8
#define CORAL_ARRAY_LIST_ERROR_ITEM_IS_NULL                         9
#define CORAL_ARRAY_LIST_ERROR_ITEM_IS_OUT_OF_BOUNDS                10
#define CORAL_ARRAY_LIST_ERROR_END_OF_SEQUENCE                      11
 ...
 * @throws CORAL_ARRAY_LIST_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 */
bool coral_array_list_invalidate(struct coral_array_list *object,
 ...
 */
bool coral_array_list_capacity(const struct coral_array_list *object,
                               uintmax_t *out);
 ...
 * @throws CORAL_ARRAY_LIST_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
bool coral_array_list_get_length(const struct coral_array_list *object,
                                 uintmax_t *out);
 ...
 */
bool coral_array_list_set_length(struct coral_array_list *object,
                                 uintmax_t length);
 ...
 * @throws CORAL_ARRAY_LIST_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 */
bool coral_array_list_shrink(struct coral_array_list *object);
 ...
 */
bool coral_array_list_remove_last(struct coral_array_list *object);

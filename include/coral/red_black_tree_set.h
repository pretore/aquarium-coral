...
#define CORAL_RED_BLACK_TREE_SET_ERROR_OBJECT_IS_NULL \
    SEA_URCHIN_ERROR_OBJECT_IS_NULL
#define CORAL_RED_BLACK_TREE_SET_ERROR_COMPARE_IS_NULL \
    SEA_URCHIN_ERROR_FUNCTION_IS_NULL
#define CORAL_RED_BLACK_TREE_SET_ERROR_SIZE_IS_ZERO \
    SEA_URCHIN_ERROR_VALUE_IS_ZERO
#define CORAL_RED_BLACK_TREE_SET_ERROR_SIZE_IS_TOO_LARGE \
    SEA_URCHIN_ERROR_VALUE_IS_TOO_LARGE
#define CORAL_RED_BLACK_TREE_SET_ERROR_OUT_IS_NULL \
    SEA_URCHIN_ERROR_OUT_IS_NULL
#define CORAL_RED_BLACK_TREE_SET_ERROR_VALUE_IS_NULL \
    SEA_URCHIN_ERROR_VALUE_IS_NULL
#define CORAL_RED_BLACK_TREE_SET_ERROR_VALUE_ALREADY_EXISTS \
    SEA_URCHIN_ERROR_VALUE_ALREADY_EXISTS
#define CORAL_RED_BLACK_TREE_SET_ERROR_VALUE_NOT_FOUND \
    SEA_URCHIN_ERROR_VALUE_NOT_FOUND
#define CORAL_RED_BLACK_TREE_SET_ERROR_ITEM_IS_NULL \
    SEA_URCHIN_ERROR_ITEM_IS_NULL
#define CORAL_RED_BLACK_TREE_SET_ERROR_ITEM_NOT_FOUND \
    SEA_URCHIN_ERROR_ITEM_NOT_FOUND
#define CORAL_RED_BLACK_TREE_SET_ERROR_MEMORY_ALLOCATION_FAILED \
    SEA_URCHIN_ERROR_MEMORY_ALLOCATION_FAILED
#define CORAL_RED_BLACK_TREE_SET_ERROR_SET_IS_EMPTY \
    SEA_URCHIN_ERROR_IS_EMPTY
#define CORAL_RED_BLACK_TREE_SET_ERROR_END_OF_SEQUENCE \
 ...
 * large.
 */
int coral_red_black_tree_set_init(struct coral_red_black_tree_set *object,
                                  size_t size,
 ...
 */
int coral_red_black_tree_set_add(struct coral_red_black_tree_set *object,
                                 const void *value);
 ...
 */
int coral_red_black_tree_set_remove(struct coral_red_black_tree_set *object,
                                    const void *value);
 ...
 * item.
 */
int coral_red_black_tree_set_next(const void *item, const void **out);
 ...
 * previous item.
 */
int coral_red_black_tree_set_prev(const void *item, const void **out);
